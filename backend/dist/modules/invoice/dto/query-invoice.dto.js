...
const update_invoice_status_dto_1 = require("./update-invoice-status.dto");
class QueryInvoiceDto {
    constructor() {
        this.page = 1;
        this.limit = 20;
    }
...
__decorate([
    ...
    (0, class_validator_1.IsIn)(update_invoice_status_dto_1.INVOICE_STATUSES),
...
__decorate([
    ...
    __metadata("design:type", String)
], QueryInvoiceDto.prototype, "customerId", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
